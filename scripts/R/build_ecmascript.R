ecmascript_mead_map <- function(){
  ...
  'svgDocument = evt.target.ownerDocument;',
               ...
               'showRiver();',
               'resetGreyStates();',
               'removeStatePicto("nevada");',
               'removeStatePicto("california");',
               'removeStatePicto("arizona");',
               'removeStatePicto("mexico");',
               '}',
               
               'function scene3(){',
               'drawStatePicto("nevada");',
               'drawStatePicto("california");',
               'drawStatePicto("arizona");',
               'drawStatePicto("mexico");',
               'removePictogram();',
               'removeRiver();',
               'moveStates();',
               'removeGreyStates();',
