add_mead_levels <- function(svg, mead_poly, mead_water_styles, mead_border_styles, group_id, water_id, border_id){
  ...
  newXMLNode('text', parent = g_id, newXMLTextNode('  '),attrs = c(id = "allocation-value-1", class='small-text', x='380',y='480',fill='#FFFFFF',stroke='none',style='text-anchor:middle;'))
  newXMLNode('text', parent = g_id, newXMLTextNode('  '),attrs = c(id = "allocation-value-2", class='small-text', x='380',y='480',dy="1.1em",fill='#FFFFFF',stroke='none',style='text-anchor:middle;'))
